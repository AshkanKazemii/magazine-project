        ...
        <section class="page-banner bg-blue rel z-1" style="background-image: url({{ asset('assets/images/background/banner-bg.png') }});">
            <div class="container">
                <div class="banner-inner">
                    <h1 class="page-title wow fadeInUp delay-0-2s" style="text-align: right">magazine {{$article->title}}</h1>
                </div>
            </div>
                    ...
                    <div class="row pb-30" >
                        ...
                        <div class="col-lg-4" style="text-align: right">
                            <div class="project-information bg-blue text-white mb-50 mr-xl-5 wow fadeInDown delay-0-2s">
                                <h3 class="project-info-title">magazine information</h3>
                                ...
                                <div class="project-info-item">
                                    <a class="btn btn-secondary btn-lg btn-block" href="{{asset($article->file)}}" download="download">Download magazine file</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-8" style="text-align: center">
                            <div class="project-content-one mr-xl-5 wow fadeInUp delay-0-2s">
                                <h2 >{{$article->title}}</h2>
                                <p><span class="h4 text-success">FA Abstract : </span>{{$article->fa_abstract}}</p>
                                <p><span class="h4 text-success"> EN Abstract : </span>{{$article->en_abstract}}</p>

                            </div>
                        </div>
                    </div>
                    <div class="project-content-two wow fadeInUp delay-0-2s">
                        <h2 style="text-align: right">Description</h2>
