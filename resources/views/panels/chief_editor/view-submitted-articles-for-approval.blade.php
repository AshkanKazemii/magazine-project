...
<main class="main-content">
    ...
    <div class="container-fluid">
                            ...
                            <table class="table">
                                ...
                                @foreach ($articles as $article)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-success" onclick="const result = confirm('آیا از تایید مقاله مطمعن هستید ؟');
        if(!result) {
            event.preventDefault();
            return false ;
        } else {
            return true ;
        }" href="{{ route("chiefeditor.submitted-articles-for-approval.success" , $article->article->id) }}">تایید</a>
                                        </td>
        ...
        if(!result) {
            ...
            return true ;
        }" href="{{ route("chiefeditor.submitted-articles-for-approval.reject" , $article->article->id) }}">رد</a>
                                        </td>
                                    </tr>
