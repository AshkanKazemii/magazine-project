            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-11">
                        <div class="hero-content rmb-75" style="text-align:right" >
                            <span class="sub-title wow fadeInUp delay-0-2s ">وب سایت مجله</span>
                            <h1 class="mb-15 wow fadeInUp delay-0-4s">وب سایت مجلهوب سایت مجلهوب سایت مجلهوب سایت مجله</h1>
                            <p class="wow fadeInUp delay-0-5s">وب سایت مجلهوب سایت مجلهوب سایت مجلهوب سا سایت مجلهوب سایت مجله</p>
                            <ul class="list-style-one mt-30 wow fadeInUp delay-0-6s">
                                <li>وب سایت مجلهوب سایت مجلهوب سایت مجله</li>
                                <li>وب سایت مجلهوب سایت مجلهوب سایت مجله</li>
                            </ul>
        ...
        <section class="partners-section rel z-1 pt-250 rpt-150 pb-90 rpb-60">
            <div class="container" style="text-align: center">
                       ...
                       <div class="section-title mb-45 ">
                           <h2>بالغ بر <span>{{ count($quarterlies) }}+</span>  مقاله در سایت مجله وجود دارد </h2>
                       </div>
        ...
        <section class="blog-section rel z-1 pb-210 rpb-100 rpb-150 rmb-30  ">
            <div class="container">
               <div class="row justify-content-center text-center">
                   <div class="col-xl-6 col-lg-8 col-md-10">
                       <div class="section-title mb-55">
                            <span class="sub-title">مجلات و مقالات</span>
                            <h2>مجلات و مقالات جدید فصل گذشته و فصل جاری</h2>
                        </div>
                   </div>
               </div>
