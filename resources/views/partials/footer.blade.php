            ...
            <div class="row align-items-center">
                <div class="col-xl-7 col-lg-6">
                    <div class="section-title mb-20">
                        <h2>در وب سایت مجله ما ، مقاله ثبت نکردید ؟ </h2>
                        <p>مرجع تمام مقالات فارسی و انگلیسی در وب سایت مجله</p>
                    </div>
                </div>
                <div class="col-xl-5 col-lg-6">
                    <div class="call-to-action-btns text-xl-right mb-20">
                        <a href="{{ route('login') }}" class="theme-btn style-two rmb-15">  شروع  <i class="fas fa-arrow-left"></i> </a>
                        <a href="{{ route('login') }}" class="theme-btn style-three rmb-15">  ورود به پنل  <i class="fas fa-arrow-left"></i> </a>
                    </div>
                </div>
            </div>
