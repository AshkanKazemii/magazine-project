        <header class="main-header">
            ...
            <div class="header-top text-center text-white bg-success py-5">
                <div class="container rel z-1">
                    <p>welcome to magazine website</p>
                            ...
                            <nav class="main-menu navbar-expand-lg">
                                ...
                                <div class="navbar-collapse collapse clearfix" id="main-menu">
                                    <ul class="navigation clearfix">
                                        ...
                                        <li class=""><a href="{{ route('index-en') }}">home</a></li>
                                        @isset($last_quarterlies[0]->id)
                                            <li><a href="{{ route('quarterly.articles-en' , $last_quarterlies[0]->id) }}">magazines</a></li>

                                        @else 
                                            <li><a href="#">magazines</a></li>

                                        @endisset
                                        <li><a href="{{ route('quarterlies-en') }}">quarterlies</a></li>
                                        <li><a href="{{ route('referees-en') }}">referees</a></li>
                                        
                                        
                                        
                                        
                                        <li><a href="">magazine info</a></li>
