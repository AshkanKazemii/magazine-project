...
<footer class="footer-section bg-lighter rel z-1">
    <div class="container">
            ...
            <div class="row align-items-center">
                <div class="col-xl-5 col-lg-6">
                    <div class="call-to-action-btns text-xl-right mb-20">
                        <a href="{{ route('login') }}" class="theme-btn style-three rmb-15"><i class="fas fa-arrow-right"></i>  login to panel  </a>
                        <a href="{{ route('login') }}" class="theme-btn style-two rmb-15">    <i class="fas fa-arrow-right"></i>start </a>
                    </div>
                </div>
                <div class="col-xl-7 col-lg-6">
                    <div class="section-title mb-20">
                        <h2>Haven't you submitted an article to our magazine website ? </h2>
                        <p>Reference for all Persian and English articles on the journal website</p>
                    </div>
                </div>

            </div>
            <img class="white-circle" src="{{ asset('assets/images/shapes/white-circle.png') }}" alt="White Circle">
            <img class="white-dots slideUpRight" src="{{ asset('assets/images/shapes/white-dots.png') }}" alt="shape">
            <img class="white-dots-circle slideLeftRight" src="{{ asset('assets/images/shapes/white-dots-circle.png') }}" alt="shape">
        </div>
        ...
        <div class="copyright-area text-center">
            <p>© {{ date("Y") }} <a href="{{ route('index') }}">ijdcs.</a> All rights reserved</p>
        </div>
    </div>
